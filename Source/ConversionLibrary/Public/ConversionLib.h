...
#include <iostream>
#include "ConversionLib.generated.h"
...
UCLASS()
class UConversionLib : public UBlueprintFunctionLibrary
{
public:
    GENERATED_BODY()
...
#pragma endregion
    ...
    //UFUNCTION(BlueprintCallable, meta = (DisplayName = "Execute Sample function", Keywords = "ConversionLibrary sample test testing"), Category = "ConversionLibraryTesting")
